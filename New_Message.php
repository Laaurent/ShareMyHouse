...
<head>
    ...
    <title>ShareMyHouse | Nouveau Message</title>
...
<div class="Title">
      <h1>Nouveau Message</h1><img src="./Img/Message.png" alt="">
    </div>

    <!-- Div pour ecrire le message -->
    <div class="Message">
        <form action="./Script/Script_Message_Send.php" class="Message_form" method="post">
          <input type="text" name="Destinataire" placeholder="Destinataire" value="<?php if (isset($_GET["ID"])){echo $_GET["ID"];}?>"><br>
          <input type="text" name="Objet" placeholder="Objet"><br>
          <textarea name="Contenu" placeholder="Contenu de votre message" rows="10"></textarea><br>
